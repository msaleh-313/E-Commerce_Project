class Admin::ProductsController < AdminController
  ...
  def update
    ...
    if @admin_product.update(admin_product_params.reject{|k| k["images"]})  #update params may sub lay aao lekin images ko reject karo
      if admin_product_params["images"]  #agr new image daali hein user nay
        admin_product_params["images"].each do |image|  #ek ek kar k nye picture ko attach kar do
